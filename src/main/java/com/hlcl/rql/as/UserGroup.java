...
public class UserGroup implements CmsClientContainer {
	...
	/**
	 * Returns from all users within this user group the mail adresses.
	 * 
	 * @see #getUsers()
	 * @see User#getEmailAddress()
	 */
	public java.util.List<String> getUsersEmailAddresses() throws RQLException {
		java.util.List<String> result = new ArrayList<String>();
		for (User u : getUsers()) {
			result.add(u.getEmailAddress());
		}
		return result;
	}
